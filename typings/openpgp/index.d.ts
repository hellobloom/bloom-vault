...
declare module 'openpgp' {
  ...
  interface NodeStream<T extends Uint8Array | string> extends BaseStream<T> { // copied+simplified version of ReadableStream from @types/node/index.d.ts
    readable: boolean; read(size?: number): T; setEncoding(encoding: string): this; pause(): this; resume(): this;
  ...
  export function verify(options: {message: message.Message.CleartextMessage, signature: signature.Signature, publicKeys: key.Key[]})
  ...
  export namespace key {
    ...
    class Key {
      ...
      toPacketlist(): packet.List<packet.AnyKeyPacket>
    }
